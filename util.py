...
def delete_files():
    # erasing created files
    if os.path.exists('./classification_file_setosa.txt'):
        os.remove('./classification_file_setosa.txt')
        print('File deleted')
    else:
        print('Error - classification_file_setosa not deleted')

    if os.path.exists('./classification_file_versicolour.txt'):
        os.remove('./classification_file_versicolour.txt')
        print('File deleted')
    else:
        print('Error - classification_file_versicolour not deleted')

    if os.path.exists('./classification_file_virginica.txt'):
        os.remove('./classification_file_virginica.txt')
        print('File deleted')
    else:
        print('Error - classification_file_virginica not deleted')

    if os.path.exists('./classification_file_all.txt'):
        os.remove('./classification_file_all.txt')
        print('File deleted')
    else:
        print('Error - classification_file_all not deleted')

    if os.path.exists('./classification_statements.txt'):
        os.remove('./classification_statements.txt')
        print('File deleted')
    else:
        print('Error - classification_statements not deleted')
